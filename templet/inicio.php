...
<div id="main" ><!-- Main -->
    ...
    <div class="container">
        ...
        <?php  $no_testimoniales = $this->pnt('no_testimoniales','2',['return'=>1]); ?>
        <p>
             <div class="jmy_web_contador" data-page="<?php echo $page; ?>"  id="no_testimoniales" data-value="<?php echo $no_testimoniales; ?>" data-button="Número de testimonios "></div>
        </p>

        <?php echo ':) '.$no_testimoniales; ?>
