            ...
            success: function(res) {
                ...
                j.forEach(e => {
                    ...
                    switch (e.type) {
                        ...
                        break;
                        default:
                        h=h+'  <li class="list-group-item list-group-item-action list-group-item-light"><div class="d-flex w-100 justify-content-between"><p class="mb-1 jmy_web_div" data-page="'+g.id+'" data-tabla="'+g.tabla+'" id="'+e.id+'" data-editor="no">'+((v[e.id]!=''&&v[e.id]!=undefined)?v[e.id]:e.value)+'</p><small>'+e.label+'</small></div></div></li>';
                        break;
                    }
                });
