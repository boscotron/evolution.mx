jQuery(function ($) { 
    ...
    function listar_marcas(d){
        ...
        $("#botones_marcas").html('');
        $("#botones_marcas").append( '<a data-filtro="toda_lista_productos" href="#" class="btn-eff3 btn_menu_productos jmy_web_div" data-page="productos" id="btn_toda_lista_productos" data-editor="no"><i class="fa fa-plus"></i></a>' ); ////toda_lista_productos
