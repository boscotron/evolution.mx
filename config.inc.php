...
define(	"TABLAS_EXTRAS","productos,citas__agendarcita,perfil,servicio,personal,testimonio,proveedor,pedido,sucursal,testjc,habitacion,reservacion,complemento"); //Base de datos
